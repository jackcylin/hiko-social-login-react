...
function SocialLoginWidget({ shop, publicAccessToken, logout, refresh, baseUrl }) {
...
function Demo({ shop, publicAccessToken, baseUrl = "https://apps.hiko.link" }) {
    const logoutCallbackRef = (0, import_react2.useRef)();
    const refreshCallbackRef = (0, import_react2.useRef)();
    const [customer, setCustomer] = (0, import_react2.useState)(window.HIKO?.customer);
    const logout = (0, import_react2.useCallback)((callback) => {
        logoutCallbackRef.current = callback;
    }, []);
    const refresh = (0, import_react2.useCallback)((callback) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
        ...
        children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
                className: "widget",
                children: [
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SocialLoginWidget, {
                        shop,
                        publicAccessToken,
                        setCustomer,
                        logout,
                    ...
                    customer
                        ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", {
                              children: Object.keys(customer).map((key) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                                      "li",
                                      { children: [key, ": ", customer[key]] },
                                      key,
                                  ),
                              ),
                          })
